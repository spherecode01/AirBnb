...
export default function PhotosUploader({ addedPhotos, onChange }) {
    ...
    async function addPhotoByLink(ev) {
        ev.preventDefault();
        const { data: filename } = await axios.post('https://air-al0p.onrender.com/upload-by-link', { link: photoLink });
        onChange(prev => {
    ...
    function uploadPhoto(ev) {
        ...
        axios.post('https://air-al0p.onrender.com/upload', data, {
    ...
    return (
        <>
            <div className="flex gap-2">
                <input value={photoLink} onChange={ev => setPhotoLink(ev.target.value)} placeholder={'Add using a link....jpg'} />
